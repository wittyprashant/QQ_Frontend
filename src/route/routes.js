...
const UserRequestDetail = React.lazy(
  () => import("../containers/UserRequest/detail")
);
...
const GroupListAddEdit = React.lazy(
  () => import("../containers/Group/addEdit")
);

const ContactList = React.lazy(() => import("../containers/Contact"));

const GroupCategory = React.lazy(() => import("../containers/GroupCategory"));
const GroupCategoryAddEdit = React.lazy(
  () => import("../containers/GroupCategory/addEdit")
);

const GroupActivity = React.lazy(() => import("../containers/GroupActivity"));
const GroupActivityAddEdit = React.lazy(
  () => import("../containers/GroupActivity/addEdit")
);

const DigitalLibrary = React.lazy(() => import("../containers/DigitalLibrary"));
const DigitalLibraryAddEdit = React.lazy(
  () => import("../containers/DigitalLibrary/addEdit")
);
const Dashboard = React.lazy(
  () => import("../components/payment dashboard/btndashboard")
);
const Transaction = React.lazy(() => import("../containers/Transaction"));
const TransactionDetail = React.lazy(
  () => import("../containers/Transaction/detail")
);
const TransactionAddEdit = React.lazy(
  () => import("../containers/Transaction/addEdit")
);
...
const routes = [
  ...
  {
    path: "/group_management/add",
    name: "Group Management",
    element: GroupListAddEdit,
    exact: true,
  },
  {
    path: "/group_management/edit/:groupId",
    name: "Group Management",
    element: GroupListAddEdit,
    exact: true,
  },
  ...
  {
    path: "/group_category_management",
    name: "Group Management",
    element: GroupCategory,
    exact: true,
  },
  {
    path: "/group_category_management/add",
    name: "Group Management",
    element: GroupCategoryAddEdit,
    exact: true,
  },
  {
    path: "/group_category_management/edit:categoryId",
    name: "Group Management",
    element: GroupCategoryAddEdit,
    exact: true,
  },
  {
    path: "/group_activity_management/:categoryName/:groupId",
    name: "Group Management",
    element: GroupActivity,
    exact: true,
  },
  {
    path: "/group_activity_management/add/:categoryName/:groupId/:maxRows",
    name: "Group Management",
    element: GroupActivityAddEdit,
    exact: true,
  },
  {
    path: "/group_activity_management/edit/:categoryName/:groupId/:maxRows/:taskId",
    name: "Group Management",
    element: GroupActivityAddEdit,
    exact: true,
  },
  ...
  {
    path: "/digital_library/add",
    name: "Add Digital Library",
    element: DigitalLibraryAddEdit,
    exact: true,
  },
  {
    path: "/digital_library/edit/:digitalId",
    name: "Edit Digital Library",
    element: DigitalLibraryAddEdit,
  },
  ...
  {
    path: "/transactions/edit/:transactionsId",
    name: "Edit Transaction",
    element: TransactionAddEdit,
  },
  {
    path: "/transactions/detail/:transactionsId",
  ...
  { path: "/faqs/edit/:faqId", name: "Edit FAQ", element: FaqAddEdit },
  {
    path: "/replays/add",
    name: "Replay Add",
    element: ReplayAddEdit,
    exact: true,
  },
  {
    path: "/replays/edit/:replayId",
    name: "Replay Edit",
    element: ReplayAddEdit,
  },
  ...
  {
    path: "/events/user_list/:eventId",
    name: "Events",
    element: EventUserList,
  },
