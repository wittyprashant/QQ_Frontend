...
class AddEdit extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.state.changedProp === false) {
      ...
      digitalLibraryDetail["oldFeatureImage"] =
        digitalLibraryDetail.featureImage;
      ...
      <CCard>
        <CCardHeader className="d-flex" component="h5">
          <div className="col-sm">
            Digital library {this.state.digitalLibraryId ? "Edit" : "Add"}
          </div>
        </CCardHeader>
        <CCardBody>
          <CForm
...
const mapDispatchToProp = (dispatch) => {
  return {
    onDigitalLibraryDetail: (id) =>
      dispatch(actions.getdigitalLibraryDetail(id)),
