...
class AddEdit extends Component {
    ...
    async componentDidMount() {
        ...
        console.log("After",this.state.country)
        if (eventId) {
            this.setState({
                eventId: eventId
            })
        ...
        return (
            <CCard>
                <CCardHeader className='d-flex' component="h5">
                    <div className="col-sm">Event {this.state.eventId ? "Edit" : "Add"}</div>
                            ...
                            >
                                <option selected="" disabled="" value=""> --- Select country ---</option>
                                {
                                    this.props.countryList.map((item, i) => (
                                        <option key={i} value={item.countryId}>{item.countryName}</option>
