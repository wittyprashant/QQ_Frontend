...
import { cilLockLocked, cilArrowCircleRight, cilBabyCarriage, cilGarage, cilRestaurant, cilEnvelopeOpen, cilOptions } from '@coreui/icons'
...
class TransactionDetail extends Component {
    ...
    reassignFunction = (e) => {
        (this.state.reassignChk === true) ? this.setState({reassignChk: false}) : this.setState({reassignChk: true});
    }
    ...
    yesPrimaryButtonClick = (e) => {
        (this.state.yesBtnClick === true) ? this.setState({yesBtnClick: false}) : this.setState({yesBtnClick: true});
    }
                ...
                <CCard>
                    ...
                    <CCardBody className="text-center">
                        <CContainer fluid>
                            ...
                            <div class="row mb-2">
                                <p> Transaction XXXXXX 2000444453531 <br/>
                                    Company</p>
                            </div>
                            <div class="row mb-2">
                                <div>
                            ...
                            <CRow className='mb-2'>
                                <CCol>
                                    <CButton class='btn-secondary'  onClick={this.personalBtnClick.bind(this)} style={{ marginRight: '10px',marginTop:'10px' }}>PERSONAL</CButton>
                                    <CButton class='btn1-secondary'  onClick={this.businessBtnClick.bind(this)}>BUSINESS</CButton>
                                </CCol>
                            </CRow>
                            
                            { this.state.primaryButton ? (
                                <CRow className='mb-2'>
                                    <h6 class='text-primary' >Do you want to ALWAYS record transactions from company as a Personal Expense?</h6>
                                    </CRow>
                                ) : '' } 
                                ...
                                { this.state.primaryButton ? (
                                    ...
                                    <CCol>
                                    <div class="sec1">
                                        <CButton size="sm" style={{ marginRight: '10px' }} onClick={this.yesPrimaryButtonClick.bind(this)}>Yes</CButton>
                            ...
                            { 
                                (this.state.primaryButton === false && this.state.businessButton === false) ? (
                                    <div class="transaction-section">
                                        <CRow className='text-crow'>
                                            <CFormSwitch  className='text-switch' onChange={this.reassignFunction.bind(this)} value="0" id="formSwitchCheckChecked"></CFormSwitch>
                            ...
                            { this.state.reassignChk ? (
                                <CRow className='drop-row'>
                                    <div class="employee"> 
                                    <DropdownButton  class='btn-drop1' onSelect={this.reasignSelectFunction.bind(this)} title={this.state.selectedEmployee}>
                            ...
                            { (this.state.selectedEmployee && this.state.reassignChk === true) ? (
                                <CRow className='drop-text'>
                                    <h6 class='text-Team' > Do you ALWAYS want to reassign transactions from Company to Team Member?</h6>
                                </CRow>
                                ) : '' } 
                                ...
                                { (this.state.selectedEmployee && this.state.reassignChk === true) ? (
                                    ...
                                    <div class="btn-section">
                                        <CButton class='yes-btn'size="sm" style={{ marginRight: '10px',marginTop:'15px' }}>Yes</CButton>
                                        <CButton class='no-btn'size="sm">No</CButton>
                                    </div>
                                    </CCol>
                            </CRow>
                                ) : '' } 
                            ...
                            { (this.state.primaryButton === true || (this.state.reassignChk === true && this.state.selectedEmployee)) ? (
                                <div class="transaction-mainsec">
                                <CRow className='text-switchrow'>
                                    <CFormSwitch  className='text-switchagain' onChange={this.reassignFunction.bind(this)} value="0" id="formSwitchCheckChecked"></CFormSwitch>
                                ...
                                { this.state.yesBtnClick ? (
                                    ...
                                    <div class="nextquerybtn2">
                                        <CButton size="sm">Next Query <CIcon icon={cilArrowCircleRight}/></CButton>
                                    </div>
                                    </CCol>
                            </CRow>
                                ) : '' } 
                            ...
                            { this.state.businessButton ? (
                                ...
                                <DropdownButton id="split-button-dropdown" onSelect={this.selectJobNumberFunction.bind(this)} title="Select a Job Number">
                                    <Dropdown.Item eventKey="1">JOB1001 - Cambelltown</Dropdown.Item>
                                    <Dropdown.Item eventKey="2">JOB1002 - Randwick</Dropdown.Item>
                            ...
                            { this.state.selectedJobNumber ? (
                                ...
                                <CRow>
                                 ...
                                 <div class="wrapper1">
                                    <div class="box" onClick={this.ClickOnTransactionFor.bind(this)}>
                            ...
                            { this.state.clickTransactionForBtn ? (
                                ...
                                <div class="transactionbtn">
                                    <CButton size="sm" style={{ marginRight: '10px' }} onClick={this.clickDoYouInvoiceBtn.bind(this)}>Yes</CButton>
                                    <CButton size="sm">No</CButton>
                                </div>
                            </CRow>
                                ) : '' } 
                        ...
                        { this.state.clickDoYouInvoiceYesBtn ? (
                            <CRow>
                                <div class="">
                                    ...
                                    <div class="transactionbtn">
                                        <CButton size="sm" style={{ marginRight: '10px' }}>Yes</CButton>
                                        <CButton size="sm">No</CButton>
                                    </div>
                            </CRow>
                                ) : '' } 
                            ...
                            <CRow className='mb-2'>
                                <CCol>
                                    ...
                                    <CDropdownToggle size="sm"> Select </CDropdownToggle>
                                        <CDropdownMenu>
                                            <CDropdownItem href="#">Record aas a personal transaction</CDropdownItem>
                                            <CDropdownItem href="#">I'll supplier an invoice later</CDropdownItem>
                                            <CDropdownItem href="#">Request from someone else</CDropdownItem>
                                            <CDropdownItem href="#">Request from supplier</CDropdownItem>
                                        </CDropdownMenu>
                                </CDropdown>
                                    </div>
                                </CCol>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProp)(TransactionDetail))