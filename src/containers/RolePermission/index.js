...
class RolePermission extends Component {
  ...
  roleChange = (event) => {
    ...
    updatedStateData = updateObject(this.state, {
      ...
      changedProp: event.target.value !== "" ? false : true,
    });
  ...
  handleChange = (event) => {
    ...
    if (event.target.id !== "roleId") {
      updatedStateData = updateObject(this.state, {
        [event.target.id]: [...event.target.selectedOptions].map(
          (o) => o.value
        ),
      });
    } else {
              ...
              <CCol sm={10}>
                ...
                >
                  ...
                  {this.props.digitalLibraryList.map((item, i) => (
                    <option key={i} value={item.digitalLibraryId}>
                      {item.title}
                    </option>
                  ))}
                </CFormSelect>
              ...
              <CCol sm={10}>
                ...
                >
                  ...
                  {this.props.fundList.map((item, i) => (
                    <option key={i} value={item.fundingId}>
                      {item.title}
                    </option>
                  ))}
                </CFormSelect>
              ...
              <CCol sm={10}>
                ...
                >
                  ...
                  {this.props.eventList.map((item, i) => (
                    <option key={i} value={item.eventId}>
                      {item.title}
                    </option>
                  ))}
                </CFormSelect>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProp)(RolePermission)
);
