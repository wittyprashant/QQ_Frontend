...
const tableData = [
   ...
   {
      category: "",
      values: ["9 Dec 2022","16 Dec 2022","23 Dec 2022","30 Dec 2022","6 Jan 2022"]
    },
   {
    ...
    {
      category: "ATO",
      values: ["$10,000", "$5,000", "$8,000", "$2,000", "$7,500"]
    },
    {
         ...
         <CTable>
            ...
            <CTableBody>
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">Approved Bills in Xero awaiting payment</CTableHeaderCell>
               ...
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">Unapproved Bills in Xero awaiting payment</CTableHeaderCell>
                  <CTableDataCell  class='text-datacell' >-$50,456</CTableDataCell>
               ...
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">ATO</CTableHeaderCell>
                  <CTableDataCell  class='text-datacell'>-$50,456</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
               ...
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">Superannuation</CTableHeaderCell>
                  <CTableDataCell  class='text-datacell'>-$50,456</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
               ...
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">AMEX Credit Card</CTableHeaderCell>
                  <CTableDataCell  class='text-datacell'>-$50,456</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
               ...
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">Loan Repayments</CTableHeaderCell>
                  <CTableDataCell  class='text-datacell'>-$50,456</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
               ...
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">Total Planned Payments</CTableHeaderCell>
                  <CTableDataCell  class='text-datacell'>-$50,456</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
               ...
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">Cash At Bank</CTableHeaderCell>
                  <CTableDataCell  class='text-datacell'>-$50,456</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
               ...
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">Expected Customer Receipts</CTableHeaderCell>
                  <CTableDataCell  class='text-datacell'>-$50,456</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
               ...
               <CTableRow class='text-tablerow'>
                  <CTableHeaderCell class='text-cell' scope="row">Cash After Payments & Receipts</CTableHeaderCell>
                  <CTableDataCell  class='text-datacashcell'>-$50,456</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
                  <CTableDataCell>-</CTableDataCell>
      ...
      <CTableBody>
        ...
        {tableData.map((rowData, index) => (
          <CTableRow key={index} className='text-ctablerow'>
            <CTableHeaderCell className='text-category' scope="row">{rowData.category}</CTableHeaderCell>
            {rowData.values.map((value, subIndex) => (
              <CTableDataCell key={subIndex} className={subIndex === 0 ? 'text-datacell' : ''}>{value}</CTableDataCell>
            ))}
          </CTableRow>
        ))}
      </CTableBody>
