          ...
          return (
            <div>
              <CTooltip content="Edit Group">
                <NavLink
                  to={"/group_management/edit/" + row.groupId}
                  type="button"
                  className="btn btn-sm btn-info mt-2 me-1"
                >
              ...
              <CTooltip content="Activities">
                <NavLink
                  ...
                  type="button"
                  className="btn btn-sm btn-success mt-2 me-1"
                >
                  <CIcon size={"sm"} icon={cilReportSlash} />
                </NavLink>
              </CTooltip>
              {/* } */}
            </div>
      ...
      <CCard>
        <CCardHeader className="d-flex" component="h5">
          ...
          <div className="col-sm text-end">
            <CTooltip content="Add Group">
              <NavLink
                to={"/group_management/add/"}
                type="button"
