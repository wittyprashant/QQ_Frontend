...
export const userList = (param) => {
  return (dispatch) => {
    ...
    axios
      .get("SuperAdmin/getallmemberslist")
      .then((response) => {
...
export const userDelete = (id) => {
  return (dispatch) => {
    axios.delete("SuperAdmin/deletemember?id=" + id).then((response) => {
      if (response.data.status) {
...
export const getPlanList = () => {
  return (dispatch) => {
    axios.get("SuperAdmin/getplancodelist").then((response) => {
...
export const getRoleList = () => {
  return (dispatch) => {
    axios.get("SuperAdmin/getuserrolelist").then((response) => {
      if (response.data.result) {
...
export const getuserDetail = (id) => {
  return (dispatch) => {
    axios.get("SuperAdmin/getmembersbyId?id=" + id).then((response) => {
      if (response.data.result) {
...
export const addEditUser = (formData) => {
  return (dispatch) => {
    ...
    axios
      .post("SuperAdmin/addupdatemember", formData)
      .then((response) => {
        if (response.data.status) {
          const data = response.data.result;
          const msg = response.data.message;
