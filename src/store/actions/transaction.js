...
export const transactionDelete = (id, token) => {
  return (dispatch) => {
    axios
      .delete("SuperAdmin/deletetransaction?transactionid=" + id)
      .then((response) => {
...
export const gettransactionDetail = (id) => {
  return (dispatch) => {
    return axios
      .get(`http://localhost:8080/api/v1/transaction/transaction-detail/${id}`)
      .then((response) => {
...
export const TransactionDetail = (id) => {
  return (dispatch) => {
    axios.get("SuperAdmin/gettransactionbyid?id=" + id).then((response) => {
...
export const transactionAddEdit = (param) => {
  return (dispatch) => {
    ...
    axios
      .post("SuperAdmin/addupdatetransaction", param)
      .then((response) => {
        if (response.data.status) {
