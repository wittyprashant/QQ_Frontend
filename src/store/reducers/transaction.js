...
const reducer = (state = intialState, action) => {
  switch (action.type) {
    case actionTypes.TRANSACTION_LIST_START:
      return transactionListStart(state, action);
    case actionTypes.TRANSACTION_LIST_FAIL:
      return transactionListFail(state, action);
    case actionTypes.TRANSACTION_LIST_SUCCESS:
      return transactionListing(state, action);
    case actionTypes.TRANSACTION_DETAIL:
      return transactionDetail(state, action);
    case actionTypes.TRANSACTION_ADD_EDIT_SUCCESS:
      return addEditSuccess(state, action);
    case actionTypes.TRANSACTION_ADD_EDIT_FAIL:
      return addEditFail(state, action);
    case actionTypes.TRANSACTION_ADD_EDIT_START:
      return addEditStart(state, action);
    case actionTypes.TRANSACTION_LIST_FILTER:
